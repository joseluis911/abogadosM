...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
      <img src ="images/nav_logo.png"class="navbar-brand" href="index.php"/>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span><span class="mr-2"><a href="#">Especialidades <i class="ion-ios-arrow-forward"></i></a></span>  <span>Mercantil <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 order-md-last ftco-animate">
            ...
            <h2 class="mb-3">Mercantil:</h2>
            <p>Estas teniendo problema con algún inmueble o cobro?.</p>
...
<!--             <div class="sidebar-box">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categorías</h3>
                <li><a href="familiar.php">Familiar<span class="ion-ios-arrow-forward"></span></a></li>
                ...
                <li class="active"><a href="mercantil.php">Mercantil <span class="ion-ios-arrow-forward"></span></a></li>
